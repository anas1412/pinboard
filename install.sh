...
# Everything runs from main, called on the last line, so bash has read the whole script
# before anything runs. With `curl | bash`, package managers would otherwise read the rest
# of the script from the same pipe.
main() {
